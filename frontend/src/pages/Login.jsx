...
const Login = () => {
    ...
    {/* container w/ gradient-background */}
            ...
            <div className='bg-neutral-300 h-screen min-w-[350px] text-neutral-800 p-5'>
                ...
                <form onSubmit={handleLogin} className='flex flex-col flex-1 px-8 py-5 rounded-xl shadow-3xl text-neutral-800'>
                    ...
                    <h2 className='mb-6 text-3xl font-bold text-center text-neutral-800'>Login</h2>
                        ...
                        <div className='relative mb-4'>
                            ...
                            className={`block w-full px-10 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none ${error ? 'border-red-600' : ''} focus:ring-zuccini-900 focus:border-zuccini-900`}/>
                        </div>
