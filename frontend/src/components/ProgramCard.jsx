export default function ProgramCard({ program }) {
    ...
    return (
            <div
              key={program.code}
              className="flex flex-col w-full h-48 overflow-hidden border max-w-[25%] xl:max-w-[10%] xl:bg-gray-500 rounded-lg shadow sm:w-1/2 md:w-1/3 lg:w-1/5 border-neutral-800 dark:bg-woodsmoke-950 dark:inset-shadow-sm dark:inset-shadow-zuccini-800"
            >
