...
export default function AreaCont({title, doneCount, doneTotal, onClick, isExpanded, onIconClick, progress}) {

    return(
        <button 
            onClick={onClick}
            className='relative flex flex-row justify-between min-w-full p-3 py-5 mb-2 transition-all duration-300 border shadow-md cursor-pointer border-neutral-400 rounded-2xl text-neutral-800 hover:scale-101 dark:text-white hover:border-neutral-500 inset-shadow-sm inset-shadow-gray-400 dark:shadow-md dark:shadow-zuccini-900 dark:bg-gray-950/50 dark:border-gray-700 dark:hover:border-gray-600'>
