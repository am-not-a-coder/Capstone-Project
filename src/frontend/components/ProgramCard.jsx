            ...
            >
              <div className="flex items-center justify-center h-2/5">
                {program.img ? (
                  ...
                  <div style={{backgroundColor: program.color}} className="w-full h-full"></div>
                )}
              </div>
              <div className="flex flex-col justify-between flex-1 p-2">
                <div>
                  <div className="text-lg font-semibold text-black dark:text-white">{program.code}</div>
                  <div className="mb-5 text-xs text-gray-500 dark:text-white">{program.name}</div>
